  ...
  return (
    ...
    <form class="mx-auto p-10 w-[500px] bg-white">
        ...
        <div class="mb-5">
                ...
                <input type="text" onChange={changeHandler} name="name" id="purpose" placeholder="Name"
            ...
            <div class="mb-5">
                ...
                <input type="text" onChange={changeHandler} name="contact" id="purpose" placeholder="Name"
                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
            <div class="mb-5">
                <label for="name" class="mb-3 block text-base font-medium text-[#07074D]">
            ...
            <div class="mb-5">
                ...
                <input type="text" onChange={changeHandler} name="address" id="purpose" placeholder="Address"
                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
            <div class="mb-5">
                <label for="appointment_to" class="mb-3 block text-base font-medium text-[#07074D]">
                appointment_to
                </label>
                <input type="text" onChange={changeHandler} name="appointment_to" id="purpose" placeholder="Address"
                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
